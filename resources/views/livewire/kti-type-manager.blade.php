<div>
    <div class="mb-8">
        <h2 class="text-4xl font-black uppercase tracking-tight mb-2 text-black">Template Manager</h2>
        <p class="text-zinc-600 font-medium">Buat dan kelola jenis KTI beserta kolom analisisnya.</p>
    </div>
                        ...
                        <div class="bg-white text-black neo-border neo-shadow p-6 flex flex-col gap-4 transform transition-transform hover:-translate-y-1">
                            ...
                            <div class="flex flex-wrap gap-2 mt-auto">
                                @foreach($type->columns as $col)
                                    ...
                                    @endphp
                                    <span class="border-2 border-black px-3 py-1 text-sm font-bold {{ $isProtectedCol ? 'bg-neo-yellow text-black' : 'bg-gray-100 text-black' }}">
                                        {{ $col }}{{ $isProtectedCol ? ' 🔒' : '' }}
                                    </span>
                                @endforeach
                            </div>
